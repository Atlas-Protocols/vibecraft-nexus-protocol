...
export interface BaseEvent {
  ...
  sessionId: string
  /** Agent ID (optional, defaults to business-os/main) */
  agentId?: string
...
// ============================================================================
// Reactor Events (Zenith Orchestrator)
// ============================================================================

export interface ReactorEvent {
  agentId: string
  type: 'task.assigned' | 'task.completed' | 'status.update' | string
...
export type ServerMessage =
  ...
  | { type: 'collaboration_event'; payload: any }
  | { type: 'reactor_event'; payload: ReactorEvent }
